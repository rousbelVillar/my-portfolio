export const Companies = () => {
  ...
  return (
    <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-700 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <div className="absolute top-[23em] left-[6em]">
        <h1 className="text-lg/8 text-gray-300 font-bold">
          {" "}
      ...
      {posts.map((post) => (
        <article
          key={post.id}
          className="flex max-w-xl flex-col items-start justify-between mt-6"
        >
